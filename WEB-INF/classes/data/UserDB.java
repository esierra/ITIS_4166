...
// This class handles the USER table.
    ...
    public static User getUser(String userID) {
        ...
        try {
            ...
            query = "SELECT userID,firstName, lastName, email, address1, address2, city, state, zipcode, country FROM user WHERE userID ='" + userID + "' ORDER BY userID";
    ...
    public ArrayList<User> getAllUsers() {
        ...
        try {
            ...
            resultSet = statement.executeQuery(
                    "SELECT userID,firstName, lastName, email, address1, address2, city, state, zipcode, country FROM user ORDER BY userID");
