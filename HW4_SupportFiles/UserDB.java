...
// This class handles the USER table.
    ...
    public User getUser(String userID) {
        ...
        try {
            ...
            query = "SELECT userName, firstName, lastName, email, address1, address2, city, state, zipcode, country FROM user WHERE userID ='" + userID + "' ORDER BY userName";
    ...
    public ArrayList<User> getAllUsers() {
        ...
        try {
            ...
            resultSet = statement.executeQuery(
                    "SELECT userName, firstName, lastName, email, address1, address2, city, state, zipcode, country FROM user ORDER BY userName");
